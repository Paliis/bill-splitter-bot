...
def help_text_html() -> str:
    return (
        ...
        "(підтягуються автоматично) і ті, кого бот уже «бачив». Найнадійніше: кожен учасник один раз "
        "надсилає в групу <code>/here</code> — команди завжди доходять, навіть якщо в BotFather увімкнено "
        "<b>Group Privacy</b> (тоді звичайні повідомлення бот може не бачити).\n\n"
        ...
        "<b>Підтримка</b>\n"
        "Після успішного розрахунку бот може запропонувати «віртуальну каву» розробнику. "
        "Кнопки Mono / Buy Me a Coffee з’являються нижче, якщо власник бота додав посилання в налаштування."
    )
