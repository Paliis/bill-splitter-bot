...
- **Покрокова інструкція (Render, токен, БД, перевірки):** [docs/STEP_BY_STEP.md](docs/STEP_BY_STEP.md)  
- **Деплой Render (скорочено):** [docs/DEPLOY_RENDER.md](docs/DEPLOY_RENDER.md)  
